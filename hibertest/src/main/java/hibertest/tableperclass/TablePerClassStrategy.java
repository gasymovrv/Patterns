...
public class TablePerClassStrategy implements InheritanceStrategyExecutable {
    @Override
    public void execute() {
        ...
        SessionFactory sessionFactory = HibernateUtil.getSessionFactory(HibernateUtil.InheritanceStrategy.TABLE_PER_CLASS);
        ...
        try {
            ...
            List billingDetails = session1.createQuery("select bd from hibertest.tableperclass.BillingDetails bd").list();
