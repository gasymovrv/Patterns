...
public class MappedSuperclassStrategy implements InheritanceStrategyExecutable {
    @Override
    public void execute() {
        ...
        SessionFactory sessionFactory = HibernateUtil.getSessionFactory(HibernateUtil.InheritanceStrategy.MAPPED_SUPERCLASS);
        ...
        try {
            ...
            List billingDetails = session1.createQuery("select bd from hibertest.mappedsuperclass.BillingDetails bd").list();
