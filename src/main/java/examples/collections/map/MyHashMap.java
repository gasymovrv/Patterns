...
public class MyHashMap<K, V> extends AbstractMap<K, V>
    ...
    static class Node<K, V> implements Entry<K, V> {
        ...
        public String toString() {
            ...
            while (temp != null) {
                sb.append(", next{" + "hash=")
                        .append(temp.hash).append(", key=")
                        .append(temp.key).append(", value=")
                        .append(temp.value).append("}");
                temp = temp.next;
            }
            sb.append("}");
            return sb.toString();
    ...
    static class EntryFromLinkedHashMap<K,V> extends MyHashMap.Node<K,V> {
        MyHashMap.Entry<K,V> before, after;
        EntryFromLinkedHashMap(int hash, K key, V value, MyHashMap.Node<K,V> next) {
     ...
     * linked node.
     */
    static final class TreeNode<K, V> extends EntryFromLinkedHashMap<K, V> {
    ...
    public String toString() {
        ...
        for (Node<K,V> n: table) {
            sb.append(counter++).append("\t").append(n).append("\n");
        }
        return sb.toString();
    }
}
