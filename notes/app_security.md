...
+ Например, злоумышленник раздобыл чужой логин и смог авторизоваться с помощью подбора пароля
или чужой sessionId и смог под ним зайти в чужую сессию.
...
пользователя.
+ **ПРИМЕР**:
    + Внедрение в БД приложения скрипта который при появлении на UI будет совершать вредоносные действия 
...
+ **ЗАЩИТА**:
    ...
    + Предупреждение типа: "Вы переходите на непроверенный ресурс"
    + Белый список урлов
