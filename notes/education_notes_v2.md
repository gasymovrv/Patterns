...
1. Блочная
    ...
    + Недостатки:
        + Сложнее представить упорядоченные данные (тут лучше использовать табличную верстку или display:table)
1. Статическая
1. Фиксированная
...
1. Как определить что верстка кроссбраузерная
    + Спецификация HTML - там указаны поддерживаемые браузеры
    + Посмотреть режим совместимости с предыдущими версиями
