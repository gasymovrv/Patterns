...
+ БЭМ
    ...
    + Если нужно выразить некую связь между блоками, то сделать это можно миксами (в примере это .form__button):
    ```html
    <button class="button button__large">Кнопка</button>
    <form class="form">
      <button class="button button__large form__button">Кнопка в форме</button>
    </form>
    ```
    + **Хорошо:** 
